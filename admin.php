    ...
    if (count($news_error)=== 0 && $uploadOk !== 0) {
       ...
       var_dump($uploadOk);
        try {
           ...
           $sql_news_creating = "Insert into  news(title, description, content, date_of_creating, image_path,category_id, autor_id) values('" . $title . "' , '" . $description . "', '" . $content . " ', '" . $date . " ', '" . $newname . " ', '" . $select . " ',  '" . $autor_id . " ')";
