...
$sql = "select n1.*, c1.id as c_id, c1.title as category_name from news as n1 left join categories as c1 ON n1.category_id=c1.id where c1.id = 4  order by id desc ";
$stmt = $conn->query($sql);
$data = $stmt->fetchAll();
?>
